<div class="tools">
	<a href="<?php echo CONTROLLER_TRANSACTIONS_ADMIN_EDITSINGLE ?>" class="button" data-icon="ui-icon-document" data-formdialog="true"><?php echo lang(LANG_KEY_BUTTON_CREATE_NEW_TRANSACTION); ?></a>
</div>
...
<table>
	...
	<?php foreach($transactionList as $key => $transaction): ?>
		<tr>
			<td><a href="<?php echo CONTROLLER_TRANSACTIONS_ADMIN_EDITSINGLE . "/" . $transaction->{DB_TRANSACTION_ID} ?>" class="button" data-icon="ui-icon-document" data-text="false" data-formdialog="true"><?php echo lang(LANG_KEY_BUTTON_EDIT_TRANSACTION); ?></a></td>
