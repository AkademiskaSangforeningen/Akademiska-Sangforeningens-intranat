<div class="tools">
<a href="<?php echo BASE_URL() . CONTROLLER_TRANSACTIONS_EDITSINGLE ?>" class="button" data-icon="ui-icon-document" data-dialog="true"><?php echo lang(LANG_KEY_BUTTON_CREATE_NEW_TRANSACTION); ?></a>
</div>
...
<table>
	...
	<?php foreach($transactionList as $key => $transaction): ?>
		<tr>
			<td><a href="<?php echo BASE_URL() . CONTROLLER_TRANSACTIONS_EDITSINGLE . "/" . $transaction->{DB_TRANSACTION_ID} ?>" class="button" data-icon="ui-icon-document" data-text="false" data-dialog="true"><?php echo lang(LANG_KEY_BUTTON_EDIT_TRANSACTION); ?></a></td>
