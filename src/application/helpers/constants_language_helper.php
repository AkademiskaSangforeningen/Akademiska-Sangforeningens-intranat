...
define('LANG_KEY_ENUM_VOICE_1_SOPRANO',						'enum_voice_1st_soprano');
define('LANG_KEY_ENUM_VOICE_2_SOPRANO',						'enum_voice_2nd_soprano');
define('LANG_KEY_ENUM_VOICE_1_ALTO',						'enum_voice_1st_alto');
define('LANG_KEY_ENUM_VOICE_2_ALTO',						'enum_voice_2nd_alto');
