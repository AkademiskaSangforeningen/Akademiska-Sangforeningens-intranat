...
Class Transaction extends CI_Model {
	...
	*/
	...
	function getTransactionList($personId = NULL, $wildCardSearch = NULL, $limit = FALSE, $offset = FALSE) {
		...
		$this->db->select(DB_TABLE_PERSON . DB_PERSON_CREATEDBY . '.' . DB_PERSON_FIRSTNAME . ' AS ' . DB_PERSON_CREATEDBY . DB_PERSON_FIRSTNAME);
		$this->db->select(DB_TABLE_PERSON . DB_PERSON_CREATEDBY . '.' . DB_PERSON_LASTNAME . ' AS ' . DB_PERSON_CREATEDBY . DB_PERSON_LASTNAME);

		$this->db->select(DB_TABLE_PERSON . DB_PERSON_MODIFIEDBY . '.' . DB_PERSON_FIRSTNAME . ' AS ' . DB_PERSON_MODIFIEDBY . DB_PERSON_FIRSTNAME);
		$this->db->select(DB_TABLE_PERSON . DB_PERSON_MODIFIEDBY . '.' . DB_PERSON_LASTNAME . ' AS ' . DB_PERSON_MODIFIEDBY . DB_PERSON_LASTNAME);		
		...
		$this->db->join(DB_TABLE_PERSON . ' AS ' . DB_TABLE_PERSON . DB_PERSON_CREATEDBY, 	DB_TABLE_TRANSACTION . '.' . DB_TRANSACTION_CREATEDBY . '=' . DB_TABLE_PERSON . DB_PERSON_CREATEDBY . '.' . DB_PERSON_ID, 'left');
		$this->db->join(DB_TABLE_PERSON . ' AS ' . DB_TABLE_PERSON . DB_PERSON_MODIFIEDBY, 	DB_TABLE_TRANSACTION . '.' . DB_TRANSACTION_MODIFIEDBY . '=' . DB_TABLE_PERSON . DB_PERSON_MODIFIEDBY . '.' . DB_PERSON_ID, 'left');
